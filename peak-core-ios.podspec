...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of peak-core-ios.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/peak-core-ios'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Robin Reiter' => 'robin7331@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/peak-core-ios.git', :tag => s.version.to_s }
